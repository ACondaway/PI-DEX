...
training paths omit the leading slash; ``pi_dex.robot.sharpa_runtime_keys`` records
...
from pi_dex.serve.deployment import CLOCK_DOMAIN_FIELD
from pi_dex.serve.deployment import OBSERVATION_TIMESTAMP_FIELD
...
from pi_dex.robot.sharpa_runtime_keys import SDK_TO_HDF5_STATE
from pi_dex.robot.sharpa_runtime_keys import SDK_TO_HDF5_VISION
...
def build_policy_observation_from_sdk(
    ...
    *,
    ...
    Returns:
        ...
        :class:`~pi_dex.serve.deployment.BimanualPolicyAdapter`.
    """
