...
1. loads a training checkpoint as :class:`~pi_dex.serve.deployment.BimanualPolicyAdapter`
...
class PiDexWebsocketPolicyServer:
    """Serve a :class:`~pi_dex.serve.deployment.BimanualPolicyAdapter` over WebSocket."""
...
def build_joint29d_server_policy(
    *,
    ...
    from pi_dex.robot.realtime_inference import load_joint29d_policy
